...
namespace CSGL12Example2
{
    ...
    public partial class CSGL12Example2Form : Form
    {




        public CSGL12Example2Handler1       mCSGL12Example2Handler1;
        public CSGL12Example2Handler2       mCSGL12Example2Handler2;
        ...
        public CSGL12Example2Form()
        {
            InitializeComponent();


            mCSGL12Example2Handler1 = new CSGL12Example2Handler1();
            mCSGL12Control1.OpenGLStarted += new CSGL12Control.DelegateOpenGLStarted( mCSGL12Example2Handler1.OpenGLStarted );
            mCSGL12Control1.KeyDown += new KeyEventHandler(mCSGL12Example2Handler1.KeyDown);
            mCSGL12Control1.KeyUp += new KeyEventHandler(mCSGL12Example2Handler1.KeyUp);
            mCSGL12Control1.MouseDown += new MouseEventHandler(mCSGL12Example2Handler1.MouseDown);
            mCSGL12Control1.MouseUp += new MouseEventHandler(mCSGL12Example2Handler1.MouseUp);
            mCSGL12Control1.MouseMove += new MouseEventHandler(mCSGL12Example2Handler1.MouseMove);
            mCSGL12Control1.MouseWheel += new MouseEventHandler(mCSGL12Example2Handler1.MouseWheel);
            mCSGL12Control1.Paint += new PaintEventHandler(mCSGL12Example2Handler1.Paint);


            mCSGL12Example2Handler2 = new CSGL12Example2Handler2();
            mCSGL12Control2.OpenGLStarted += new CSGL12Control.DelegateOpenGLStarted(mCSGL12Example2Handler2.OpenGLStarted);
            mCSGL12Control2.KeyDown += new KeyEventHandler(mCSGL12Example2Handler2.KeyDown);
            mCSGL12Control2.KeyUp += new KeyEventHandler(mCSGL12Example2Handler2.KeyUp);
            mCSGL12Control2.MouseDown += new MouseEventHandler(mCSGL12Example2Handler2.MouseDown);
            mCSGL12Control2.MouseUp += new MouseEventHandler(mCSGL12Example2Handler2.MouseUp);
            mCSGL12Control2.MouseMove += new MouseEventHandler(mCSGL12Example2Handler2.MouseMove);
            mCSGL12Control2.MouseWheel += new MouseEventHandler(mCSGL12Example2Handler2.MouseWheel);
            mCSGL12Control2.Paint += new PaintEventHandler(mCSGL12Example2Handler2.Paint);
        ...
        private void PrivateActivatedEventHandler(object sender, EventArgs e)
        {
            ...
            if 
            (
                (false == mCSGL12Control1.Focused)
                && (false == mCSGL12Control2.Focused)
            )
            {
                mCSGL12Control1.Focus();
            }
        ...
        protected override bool ProcessDialogKey(Keys keyData)
        {
                ...
                )
            {
                ...
                {
                    mCSGL12Example2Handler1.KeyDown(mCSGL12Control1, e);
                }
                else if (true == mCSGL12Control2.Focused)
                {
                    mCSGL12Example2Handler2.KeyDown(mCSGL12Control2, e);
                }
                else
                {
